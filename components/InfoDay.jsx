...
const InfoDay = () => {
  ...
  return (
    <section className="w-full flex flex-row items-center justify-evenly text-white">
      <div className="flex flex-col items-center sm:flex-row">
        <Image src="/rain.png" alt="rain" width={50} height={50} />
        <ul className="p-2">
          <li className="sm:text-lg text-sm pt-2">Chance Rain</li>
      ...
      <div className="flex flex-col items-center sm:flex-row">
        ...
        <ul className="p-2">
          <li className="sm:text-lg text-sm pt-2">Windy</li>
      ...
      <div className="flex flex-col items-center sm:flex-row">
        ...
        <ul className="p-2 ">
          <li className="sm:text-lg text-sm pt-2">UV Index</li>
      ...
      <div className="flex flex-col items-center sm:flex-row">
        ...
        <ul className="p-2">
          <li className="sm:text-lg text-sm pt-2">Sunrise</li>
      ...
      <div className="flex flex-col items-center sm:flex-row">
        ...
        <ul className="p-2">
          <li className="sm:text-lg text-sm pt-2">Sunset</li>
